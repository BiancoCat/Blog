...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		// },
		{
			...
			url: "https://space.bilibili.com/343649302",
		},
		{
			name: "Steam",
			icon: "fa6-brands:steam",
			url: "https://steamcommunity.com/profiles/76561199003557726/",
		},
		{
			name: "GitHub",
...
export const gitHubEditConfig: GitHubEditConfig = {
	enable: true,
	baseUrl: "https://github.com/BiancoCat/Blog/blob/main/src/content/posts",
};
